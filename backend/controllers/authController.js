...
exports.signup = catchAsync(async (req, res, next) => {
    ...
    // TODO: After the basic auth system, create send welcome message with email system
...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (!currentUser) return next(new AppError('The user belonging to thsi token does no longer exist!', 401));
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    // TODO: After creatin this basic auth system, update this email function for production
    const resetURL = `${req.protocol}://${req.get('host')}/api/v1/users/resetPassword/${resetToken}`;
    const message = `Forgot your password? Submit a PATCH request with your new password and passwordConfirm to: ${resetURL}.\n If you did not forget your password, then please ignore thsi email!`;
    ...
    try {
        ...
        return next(new AppError('There was an error occured while sending the email. Please try again later!', 500));
    };
});
